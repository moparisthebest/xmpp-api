...
public class XmppSignatureResult implements Parcelable {
    /**
    ...
    private XmppSignatureResult(int signatureStatus, String signatureUserId, long keyId,
    ...
    private XmppSignatureResult(Parcel source, int version) {
    ...
    public static final Creator<XmppSignatureResult> CREATOR = new Creator<XmppSignatureResult>() {
        public XmppSignatureResult createFromParcel(final Parcel source) {
            int version = source.readInt(); // parcelableVersion
            int parcelableSize = source.readInt();
            int startPosition = source.dataPosition();

            XmppSignatureResult vr = new XmppSignatureResult(source, version);
        ...
        public XmppSignatureResult[] newArray(final int size) {
            return new XmppSignatureResult[size];
        }
    };
    ...
    public String toString() {
        ...
        out += "\nuserIds: " + userIds;
        out += "\nkeyId: " + XmppUtils.convertKeyIdToHex(keyId);
        return out;
    }

    public static XmppSignatureResult createWithValidSignature(int signatureStatus, String primaryUserId,
        ...
        return new XmppSignatureResult(signatureStatus, primaryUserId, keyId, userIds, confirmedUserIds,
                senderStatusResult, null, signatureTimestamp, null);
    }

    public static XmppSignatureResult createWithNoSignature() {
        return new XmppSignatureResult(RESULT_NO_SIGNATURE, null, 0L, null, null, null, null, null, null);
    }

    public static XmppSignatureResult createWithKeyMissing(long keyId, Date signatureTimestamp) {
        return new XmppSignatureResult(RESULT_KEY_MISSING, null, keyId, null, null, null, null, signatureTimestamp, null);
    }

    public static XmppSignatureResult createWithInvalidSignature() {
        return new XmppSignatureResult(RESULT_INVALID_SIGNATURE, null, 0L, null, null, null, null, null, null);
    }

    @Deprecated
    public XmppSignatureResult withSignatureOnlyFlag(boolean signatureOnly) {
        return new XmppSignatureResult(result, primaryUserId, keyId, userIds, confirmedUserIds,
                senderStatusResult, signatureOnly, signatureTimestamp, autocryptPeerentityResult);
    }

    public XmppSignatureResult withAutocryptPeerResult(AutocryptPeerResult autocryptPeerentityResult) {
        return new XmppSignatureResult(
