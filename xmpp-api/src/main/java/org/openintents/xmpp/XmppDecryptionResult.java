...
public class XmppDecryptionResult implements Parcelable {
    /**
    ...
    public XmppDecryptionResult(int result) {
        this.result = result;
        this.sessionKey = null;
        this.decryptedSessionKey = null;
    }

    public XmppDecryptionResult(int result, byte[] sessionKey, byte[] decryptedSessionKey) {
        this.result = result;
    ...
    public static final Creator<XmppDecryptionResult> CREATOR = new Creator<XmppDecryptionResult>() {
        public XmppDecryptionResult createFromParcel(final Parcel source) {
            ...
            XmppDecryptionResult vr = new XmppDecryptionResult(result, sessionKey, decryptedSessionKey);
        ...
        public XmppDecryptionResult[] newArray(final int size) {
            return new XmppDecryptionResult[size];
        }
    };
