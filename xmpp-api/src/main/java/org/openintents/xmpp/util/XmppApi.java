...
public class XmppApi {
    ...
    @Deprecated
    public static final String ACTION_SIGN = "org.openintents.xmpp.action.SIGN";
     ...
     */
    public static final String ACTION_CLEARTEXT_SIGN = "org.openintents.xmpp.action.CLEARTEXT_SIGN";
     ...
     */
    public static final String ACTION_DETACHED_SIGN = "org.openintents.xmpp.action.DETACHED_SIGN";
     ...
     */
    public static final String ACTION_ENCRYPT = "org.openintents.xmpp.action.ENCRYPT";
     ...
     * boolean       EXTRA_ENABLE_COMPRESSION    (enable ZLIB compression, default ist true)
     */
    public static final String ACTION_SIGN_AND_ENCRYPT = "org.openintents.xmpp.action.SIGN_AND_ENCRYPT";

    public static final String ACTION_QUERY_AUTOCRYPT_STATUS = "org.openintents.xmpp.action.QUERY_AUTOCRYPT_STATUS";
     ...
     * 
     * returned extras:
     * XmppSignatureResult   RESULT_SIGNATURE
     * XmppDecryptionResult  RESULT_DECRYPTION
     * XmppDecryptMetadata   RESULT_METADATA
     * String                   RESULT_CHARSET   (charset which was specified in the headers of ascii armored input, if any)
     */
    public static final String ACTION_DECRYPT_VERIFY = "org.openintents.xmpp.action.DECRYPT_VERIFY";
     ...
     * String                   RESULT_CHARSET   (charset which was specified in the headers of ascii armored input, if any)
     */
    public static final String ACTION_DECRYPT_METADATA = "org.openintents.xmpp.action.DECRYPT_METADATA";
     ...
     * long[]        RESULT_KEY_IDS
     */
    public static final String ACTION_GET_KEY_IDS = "org.openintents.xmpp.action.GET_KEY_IDS";

    /**
     * This action returns RESULT_CODE_SUCCESS if the XMPP Provider already has the key
     ...
     */
    public static final String ACTION_GET_KEY = "org.openintents.xmpp.action.GET_KEY";
     ...
     */
    public static final String ACTION_BACKUP = "org.openintents.xmpp.action.BACKUP";

    public static final String ACTION_UPDATE_AUTOCRYPT_PEER = "org.openintents.xmpp.action.UPDATE_AUTOCRYPT_PEER";
    ...
    // XMPP Radix-64, 33 percent overhead compared to binary, see http://tools.ietf.org/html/rfc4880#page-53)
    ...
    IXmppService mService;
    Context mContext;
    final AtomicInteger mPipeIdGen = new AtomicInteger();

    public XmppApi(Context context, IXmppService service) {
    ...
    private class XmppAsyncTask extends AsyncTask<Void, Integer, Intent> {
        Intent data;
        InputStream is;
        OutputStream os;
        IXmppCallback callback;

        private XmppAsyncTask(Intent data, InputStream is, OutputStream os, IXmppCallback callback) {
            this.data = data;
            this.is = is;
            this.os = os;
    ...
    public void executeApiAsync(Intent data, InputStream is, OutputStream os, IXmppCallback callback) {
        XmppAsyncTask task = new XmppAsyncTask(data, is, os, callback);
    ...
    public Intent executeApi(Intent data, InputStream is, OutputStream os) {
        ...
        try {
            ...
            Log.e(XmppApi.TAG, "Exception in executeApi call", e);
            ...
            if (input != null) {
                try {
                    ...
                    Log.e(XmppApi.TAG, "IOException when closing ParcelFileDescriptor!", e);
                }
            }
        }
    }
    ...
    public Intent executeApi(Intent data, ParcelFileDescriptor input, OutputStream os) {
        ...
        try {
            ...
            data.putExtra(EXTRA_API_VERSION, XmppApi.API_VERSION);
