...
public class XmppAppPreference extends DialogPreference {
    ...
    public XmppAppPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        populateAppList();
    }

    public XmppAppPreference(Context context) {
        this(context, null);
    }
    ...
    public void addLegacyProvider(int position, String packageName, String simpleName, Drawable icon) {
        mLegacyList.add(position, new XmppProviderEntry(packageName, simpleName, icon));
    }
    ...
    public void addLegacyProvider(String packageName, String simpleName, int iconRes) {
        ...
        mLegacyList.add(new XmppProviderEntry(packageName, simpleName, icon));
    }
    ...
    protected void onPrepareDialogBuilder(Builder builder) {
        ...
        // Init ArrayAdapter with XMPP Providers
        ListAdapter adapter = new ArrayAdapter<XmppProviderEntry>(getContext(),
        ...
        builder.setSingleChoiceItems(adapter, getIndexOfProviderList(mSelectedPackage),
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        XmppProviderEntry entry = mList.get(which);
                        ...
                        if (entry.intent != null) {
                             ...
                             * as the user might remove the currently used XMPP app.
                             */
                         ...
                         * the dialog.
                         */
                        XmppAppPreference.this.onClick(dialog, DialogInterface.BUTTON_POSITIVE);
                        dialog.dismiss();
                    }
                });
    ...
    private int getIndexOfProviderList(String packageName) {
        for (XmppProviderEntry app : mList) {
    ...
    public String getEntryByValue(String packageName) {
        ...
        return getContext().getString(R.string.xmpp_list_preference_none);
    }
    ...
    private void populateAppList() {
        ...
        // add "none"-entry
        mList.add(0, new XmppProviderEntry("",
                getContext().getString(R.string.xmpp_list_preference_none),
        ...
        if (resInfo != null) {
            for (ResolveInfo resolveInfo : resInfo) {
                ...
                if (!PROVIDER_BLACKLIST.contains(packageName)) {
                    mList.add(new XmppProviderEntry(packageName, simpleName, icon));
    ...
    private static class XmppProviderEntry {
        private String packageName;
        private String simpleName;
        private Drawable icon;
        private Intent intent;

        XmppProviderEntry(String packageName, String simpleName, Drawable icon) {
            this.packageName = packageName;
            this.simpleName = simpleName;
            this.icon = icon;
        }

        XmppProviderEntry(String packageName, String simpleName, Drawable icon, Intent intent) {
